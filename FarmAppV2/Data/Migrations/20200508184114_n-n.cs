    ...
    public partial class nn : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SheepVaccine", x => new { x.SheepId, x.VaccineId });
                    table.ForeignKey(
                        name: "FK_SheepVaccine_Sheep_SheepId",
                        column: x => x.SheepId,
                        principalTable: "Sheep",
                        principalColumn: "SheepId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SheepVaccine_Vaccine_VaccineId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SheepVaccine_VaccineId",
                table: "SheepVaccine",
                column: "VaccineId");
